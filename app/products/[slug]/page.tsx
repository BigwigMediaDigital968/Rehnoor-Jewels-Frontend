...
//   return { title: `${p.name} | Rehnoor Jewels`, description: p.description };
// }
...
//   return (
//     <main>
//       {/* Client wrapper handles cart + checkout logic */}
...
export default async function ProductDetailPage({
  ...
  return (
    <main>
      {/* Receives full product — cart/wishlist logic lives inside */}
      <ProductDetailWrapper product={product} />
      <ProductTabs />
      <ProductReviews />
