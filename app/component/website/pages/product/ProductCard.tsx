...
// app/products/component/ProductCard.tsx
// ProductCard — fully wired to cartStore + wishlistStore
// Accepts Product type (adapted from ApiProduct via adaptProduct in ProductGrid)
"use client";
...
export default function ProductCard({ product }: { product: Product }) {
  ...
  // Quick-add to cart from card (no size = Free Size for size-less products)
  const handleQuickAdd = (e: React.MouseEvent) => {
    e.preventDefault();
    // If product has sizes, open quick view instead
