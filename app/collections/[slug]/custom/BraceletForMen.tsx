        ...
        <div className="container-rj section-padding py-20 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              crafted for those who wear their style with confidence. Each piece
              is designed to give you a rich, premium gold look at an affordable
              price, perfect for everyday wear as well as special occasions.
            </motion.p>
          </div>
        </div>
      </Section>
        ...
        <div className="container-rj">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16 items-center">
            ...
            <div>
              ...
              >
                Gold plated bracelets for men are bracelets crafted from a base
                metal such as brass or copper, electroplated with a layer of
                real gold, giving them the bold and luxurious appearance of
          ...
          <div className="flex text-center justify-center mb-12">
            <motion.div variants={fadeUp} custom={0}>
              ...
              <p className="text-white/60 mt-3 max-w-3xl">
                ...
                the most popular gold plated bracelets for men styles available
                at Rehnoor Jewels:{" "}
              </p>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-start">
            <div className="lg:col-span-2 lg:sticky lg:top-28">
              <motion.div variants={fadeUp} custom={0}>
                ...
                >
                  When it comes to buying gold plated bracelets for men online,
          ...
          >
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              >
                ...
                Jewels make every occasion a little more special.
              </p>
      ...
      >
        ...
        <div className="container-rj relative z-10 text-center">
          ...
          >
            ...
            reflects his personality and elevates his style. Browse our one gram
            gold bracelets for men collection today and find the perfect piece
            for your wrist.
          </motion.p>
