          ...
          <div className="container-rj">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16 items-center">
              ...
              <div>
                ...
                >
                  A gold plated chain for men is a chain crafted from a base
                  metal such as brass or copper, electroplated with a layer of
                  real gold, giving it the rich and luxurious appearance of a
                  solid gold chain for men at a fraction of the cost.
                </motion.p>
                <motion.p
                  variants={fadeUp}
                  custom={2}
                ...
                >
                  ...
                  collection is designed to offer you premium quality, a
                  flawless finish, and stunning designs that suit every style
                  and occasion without putting a strain on your budget.
                </motion.p>
            ...
            <div className="flex justify-center text-center mb-12">
              <motion.div variants={fadeUp} custom={0}>
                ...
                <p className="text-white/60 max-w-4xl text-center mt-3">
                  ...
                  right piece. Here are the most popular gold plated chain for
                  men available at Rehnoor Jewels:
                </p>
              </motion.div>
            </div>
          ...
          <div className="container-rj relative z-10">
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-10">
                <motion.div variants={fadeUp} custom={0}>
                  ...
                  <p className="text-white/50 mt-2">
                    One of the most common questions buyers have before
                    purchasing a gold plated chain for men is how long the gold
                    plating will last. The answer depends on how well you care
                    for your piece. Here is what you can expect:{" "}
                  </p>
                </motion.div>
              </div>
              ...
              <p className="mt-5 text-white/60 text-center">
                ...
                chain for men from Rehnoor Jewels will remain a cherished part
        ...
        >
          ...
          <div className="container-rj relative z-10 text-center">
            ...
            >
              ...
              quality, stunning designs, and great value all in one place.
              Browse our 1 gram gold chain for men collection today and find the
              perfect piece that speaks to your style.
            </motion.p>
            {/* 
          <motion.div
            variants={fadeUp}
